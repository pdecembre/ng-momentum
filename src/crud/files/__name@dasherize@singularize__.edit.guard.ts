...
@Injectable()
/**
 * Edit View guard for view access and data preloading.
 */
export class Edit<%= classify(singularize(name)) %>Guard implements CanActivate, Resolve<<%= classify(singularize(vo)) %>> {
