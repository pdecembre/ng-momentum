    ...
    describe('with project', () => {
        ...
        it('works with pwa', () => {
            ...
            expect(tree.files.sort()).toEqual([
                ...
                '/projects/bar/src/app/vos/.gitkeep',
                '/projects/bar/src/assets/.gitkeep',
                '/projects/bar/src/assets/icons/icon-128x128.png',
                '/projects/bar/src/assets/icons/icon-144x144.png',
                '/projects/bar/src/assets/icons/icon-152x152.png',
                '/projects/bar/src/assets/icons/icon-192x192.png',
                '/projects/bar/src/assets/icons/icon-384x384.png',
                '/projects/bar/src/assets/icons/icon-512x512.png',
                '/projects/bar/src/assets/icons/icon-72x72.png',
                '/projects/bar/src/assets/icons/icon-96x96.png',
                '/projects/bar/src/environments/environment.prod.ts',
                '/projects/bar/src/environments/environment.ts',
                '/projects/bar/src/favicon.ico',
                '/projects/bar/src/index.html',
