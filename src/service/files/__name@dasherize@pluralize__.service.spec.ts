...
describe('<%= classify(pluralize(name)) %>Service', () => {
    ...
    it('is created', inject([<%= classify(pluralize(name)) %>Service, HttpTestingController], (service: <%= classify(pluralize(name)) %>Service, httpMock: HttpTestingController) => {
        expect(service).toBeTruthy();
    }));

    <% if(operations.indexOf('l')>-1){ %>
        describe('list', () => {
            it('returns response', inject([<%= classify(pluralize(name)) %>Service, HttpTestingController], (service: <%= classify(pluralize(name)) %>Service, httpMock: HttpTestingController) => {
            ...
            it('returns error', inject([<%= classify(pluralize(name)) %>Service, HttpTestingController], (service: <%= classify(pluralize(name)) %>Service, httpMock: HttpTestingController) => {
    ...
    <% if(operations.indexOf('r')>-1){ %>
        describe('show', () => {
            it('return response', inject([<%= classify(pluralize(name)) %>Service, HttpTestingController], (service: <%= classify(pluralize(name)) %>Service, httpMock: HttpTestingController) => {
            ...
            it('return error', inject([<%= classify(pluralize(name)) %>Service, HttpTestingController], (service: <%= classify(pluralize(name)) %>Service, httpMock: HttpTestingController) => {
